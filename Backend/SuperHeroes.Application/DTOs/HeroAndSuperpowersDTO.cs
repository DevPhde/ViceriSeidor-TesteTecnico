...
{
    public class HeroAndSuperpowersDTO
    {
        public HeroAndSuperpowersDTO(int id, string nome, string nomeHeroi, DateTime? dataNascimento, float altura, float peso, ICollection<SuperpowerDTO> superpowers)
        {
            Id = id;
            Nome = nome;
            NomeHeroi = nomeHeroi;
